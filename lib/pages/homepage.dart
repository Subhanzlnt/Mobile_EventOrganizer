...
import 'package:sidebar_animation/models/date_model.dart';
import 'package:sidebar_animation/models/events_model.dart';
import 'package:sidebar_animation/models/event_type_model.dart';
                    ...
                    Row(
                      children: <Widget>[
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: <Widget>[
                            Text("Hello, Abi!", style: TextStyle(
                                color: Colors.white,
